...
interface SheetPortalProperties
...
const SheetPortal = ({
  ...
  children,
  ...properties
}: SheetPortalProperties) => (
  <SheetPrimitive.Portal className={clsx(className)} {...properties}>
...
>(({ position, size, className, children, ...properties }, reference) => (
